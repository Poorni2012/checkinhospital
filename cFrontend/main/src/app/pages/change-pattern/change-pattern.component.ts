  ...
  changePattern(changePatternForm: NgForm) {
    if (changePatternForm.valid && this.newPatternCode && this.oldPatternCode && this.confirmPatternCode) {
      ...
      let changePatternParams = {
        current_pattern: this.oldPatternCode,
        pattern: this.newPatternCode,
        confirm_pattern: this.confirmPatternCode
      };
      this.apiService.postRequest('admin/changepattern', changePatternParams).subscribe((patternResponse: any) => {
