...
exports.checkin = async (data, file) => {
    ...
    if (check) {
        ...
        let createDate = { userId: userToken.userId, ...restData, file: file.path }
        let update = await CHECKIN.updateMany({ userId: userToken.userId }, { $set: { ...data, file: file.path } })
